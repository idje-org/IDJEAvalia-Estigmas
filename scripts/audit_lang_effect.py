...
SAMPLE_PT = os.path.join(BASE, "idioma", "amostras", "sample_lang_pt.csv")
SAMPLE_EN = os.path.join(BASE, "idioma", "amostras", "sample_lang_en.csv")
PT_DIR = os.path.join(BASE, "resultados")
EN_DIR = os.path.join(BASE, "idioma", "resultados", "en")
...
def main():
    ...
    for mid in sorted(MODELOS):
        pt_path = os.path.join(PT_DIR, f"modelo_{mid}.csv")
